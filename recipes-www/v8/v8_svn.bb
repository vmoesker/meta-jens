include v8.inc
SRC_URI = "svn://v8.googlecode.com/svn;protocol=http;module=trunk;rev=23139;path_spec=v8 \
svn://gyp.googlecode.com/svn;module=trunk;protocol=http;rev=1831;path_spec=v8/build/gyp \
svn://src.chromium.org/chrome/trunk;module=deps/third_party/icu52;protocol=http;rev=277999;path_spec=v8/third_party/icu \
